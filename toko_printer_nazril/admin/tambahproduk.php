...
<body>
    ...
    <div class="content">
        <h3 class="text-4xl font-bold text-center my-3 bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent">Tambah Data Produk - Toko Printer Nazril</h3>
